...
func TestDeriveUpstreamEndpoint(t *testing.T) {
	tests := []struct {
		...
		{"minimax image generations", EndpointImagesGenerations, "/v1/images/generations", service.PlatformMiniMax, "/v1/image_generation"},
		{"minimax speech", EndpointAudioSpeech, "/v1/audio/speech", service.PlatformMiniMax, "/v1/t2a_v2"},
